...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0"><b>MANTENIMIENTO DE SECCIONES</b></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title"><i class="nav-icon fas fa-th"></i>&nbsp;&nbsp;<b>Listado de Secciones</b></h3>
            <button class="btn btn-success float-right" onclick="AbrirRegistro()"><i class="fas fa-plus"></i> Nuevo Registro</button>
          </div>
          <div class="table-responsive" style="text-align:center">
          <div class="card-body">
          <table id="tabla_secciones" class="table table-striped table-bordered" style="width:100%">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-12 form-group">
            ...
            <input type="text" class="form-control" id="txt_seccion" onkeypress="return sololetras(event)">
          </div>
          <div class="col-12 form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success" onclick="Registrar_Seccion()"><i class="fas fa-save"></i> Registrar</button>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-12 form-group">
            ...
            <input type="text" class="form-control" id="txt_seccion_editar" onkeypress="return sololetras(event)">
          </div>
          <div class="col-12 form-group">
            <label for="">Descripción<b style="color:red">(*)</b>:</label>

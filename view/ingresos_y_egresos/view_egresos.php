<script src="../js/console_egresos.js?rev=<?php echo time();?>"></script>
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0"><b>MANTENIMIENTO DE EGRESOS</b></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title"><i class="nav-icon fas fa-th"></i>&nbsp;&nbsp;<b>Listado de Egresos Diversos</b></h3>
            ...
            <div class="card-body">
                <div class="row">               
                    ...
                    <div class="col-12 col-md-3" role="document">
                        <label for="">&nbsp;</label><br>
                        <button onclick="listar_egresos_diversos_filtro()" class="btn btn-danger mr-2" style="width:100%" onclick><i class="fas fa-search mr-1"></i>Buscar por fechas</button>
                    </div>
                    <div class="col-12 col-md-3" role="document">
                        <label for="">&nbsp;</label><br>
                        <button onclick="listar_egresos_diversos()" class="btn btn-success mr-2" style="width:100%" onclick><i class="fas fa-search mr-1"></i>Listar egresos hoy</button>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="card-body">
          <table id="tabla_egresos_diversos" class="table table-striped table-bordered" style="width:100%">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success" onclick="Registrar_egreso()"><i class="fas fa-save"></i> Registrar</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="modal_editar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#1FA0E0;">
        <h5 class="modal-title" id="exampleModalLabel" style="color:white; text-align:center"><b>EDITAR DATOS DEL GASTO</b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="row">
          ...
          <div class="col-12 form-group">
            ...
            <input type="text" name="" id="txt_id_egreso" hidden>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-times ml-1"></i> Cerrar</button>
        <button type="button" class="btn btn-success" onclick="Modificar_Egreso()"><i class="fas fa-check"></i> Modificar</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="modal_anular" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#1FA0E0;">
        <h5 class="modal-title" id="exampleModalLabel" style="color:white; text-align:center"><b>ANULAR GASTO</b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="row">
          ...
          <div class="col-12 form-group">
            ...
            <input type="text" name="" id="txt_id_egreso_anular" hidden>
